        ...
        <div style={S.overlay} onClick={e => e.target === e.currentTarget && setShowForm(false)}>
          <div style={S.modal} className="animate-in">
            ...
            <div style={S.modalBody}>
              ...
              {tab === 'groups' && (
                <div style={S.field}>
                  <input placeholder="Buscar grupo..." value={groupSearch} onChange={e => setGroupSearch(e.target.value)} style={{ ...S.input, marginBottom: '6px', fontSize: '12px' }} />
                  <div style={S.listBox}>
                    {groups.length === 0 ? (
              ...
              {tab === 'templates' && (
                <div style={S.field}>
                  <input placeholder="Buscar template..." value={tplSearch} onChange={e => setTplSearch(e.target.value)} style={{ ...S.input, marginBottom: '6px', fontSize: '12px' }} />
                  <div style={S.listBox}>
                    {templates.length === 0 ? (
                      <div style={{ fontSize:'12px', color:'var(--text-muted)', padding:'8px', textAlign:'center' }}>Carregando templates...</div>
                    ) : templates.filter(t => !tplSearch || t.name?.toLowerCase().includes(tplSearch.toLowerCase())).map(t => (
